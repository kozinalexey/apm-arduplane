...
const AP_Param::GroupInfo AP_GPS::var_info[] PROGMEM = {
    ...
    AP_GROUPINFO("FILTERPE", 0, AP_GPS, _filterpe, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("FILTERSPD", 1, AP_GPS, _filterspd, 0),
    ...
    // @Units: Degrees
    // @User: Advanced
    //AP_GROUPINFO("MIN_ELEV", 3, AP_GPS, _min_elevation, -100),
...
//const uint32_t AP_GPS::_baudrates[] PROGMEM = {115200U};

// initialisation blobs to send to the GPS to try to get it into the
// right mode
const prog_char AP_GPS::_initialisation_blob[] PROGMEM = ""; //UBLOX_SET_BINARY MTK_SET_BINARY SIRF_SET_BINARY; //!todo
