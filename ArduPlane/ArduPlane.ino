...
#define THISFIRMWARE "ArduPlane V3.3+R01"
/*
Custom arduplane firmware for APM2  by Megapilot.ru group

based ArduPlane V3.3 6be0932d82d21893738ea36b245f9109e1a09542
...
static int8_t camerafeedbackpin =-1 ;
...
static void update_mount(void)
{
    ...
    log_picture_feedback(0); //log camera if feedback received
#endif
}
